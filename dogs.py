...
#   copying a list of items into another liist, and changing the data in the list.
...
def main ():
    how_many = len(dogs)
    print("\nNumber of dogs in the lsit:" + str(how_many))
    print("\nOriginal lsit of dog names:")
    print(dogs)
    ...
    print("\nNote: Position numbers ina list begin with 0, not with 1")
    print("Pop a dog off from position 3 (which is the 4th dog) in the list:")
    print(dogs)
    print(another_dog + " was removed from position 3 of the lsit.")
